...
// Database Connection width MongoDB
mongoose.connect(process.env.ENVIRMENT);
...
// Creating API for Getting One Products
app.get('/SelectOneProducts', async (req, res) => {
    let products = await Product.find({id: req.body.id});
    console.log("SelectOne Products fetched");
    res.send(products);
});
...
// Craeteing Endpoint for registering the user
